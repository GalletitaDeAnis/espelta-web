...
export function HomeTopSection() {
  return (
    <section className="relative min-h-[780px] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#020815]/85 via-[#0b1e43]/40 to-[#020815]/55" />
      ...
      <div className="relative z-10 mx-auto flex h-[740px] w-full max-w-[1380px] items-center px-6">
        <div className="max-w-[650px] rounded-2xl border border-white/20 bg-black/25 p-7 pt-8 shadow-[0_16px_40px_rgba(0,0,0,0.35)] backdrop-blur-[2px] md:p-10">
          <p className="mb-4 inline-flex rounded-full border border-white/25 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-white/90">
