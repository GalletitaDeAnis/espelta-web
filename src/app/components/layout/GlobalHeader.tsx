    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-black/15 bg-[#001d75] px-4 py-2.5 shadow-lg">
      <div className="mx-auto flex w-full max-w-[1480px] items-center gap-2.5">
        ...
        <div className="ml-auto hidden items-center gap-4 xl:flex">
          ...
          <div className="min-w-[200px] text-right leading-tight text-white">
            <p className="whitespace-nowrap text-[13px] font-semibold text-white/85">¿Tienes alguna duda?</p>
            <div className="mt-0.5 flex items-center justify-end gap-1.5 whitespace-nowrap text-[17px] font-bold leading-none">
              <span className="inline-flex h-[28px] w-[28px] items-center justify-center rounded-full bg-[#25d366]">
          ...
          <a
            href="#"
            className="min-w-[132px] whitespace-nowrap rounded-lg bg-[#f20f17] px-7 py-3 text-[17px] font-semibold text-white transition hover:bg-[#d50a11]"
          >
            Contactar ahora
          </a>
        </div>
