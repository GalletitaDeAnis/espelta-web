...
export function SiteFooterSection() {
  return (
    <footer className="border-t border-white/20 bg-footer py-16 px-5 text-white flex flex-col gap-12">
      <div className="mx-auto grid w-full max-w-[1400px] gap-12 md:grid-cols-[1.2fr_1.2fr_1fr]">
        <div className="flex flex-col items-start">
          ...
          <p className="max-w-[360px] text-[14px] leading-relaxed text-white/75">
        ...
        <div className="rounded-2xl bg-white p-8 text-slate-700 border border-slate-200 shadow-md relative overflow-hidden group">
          <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50 transition-opacity duration-500 group-hover:opacity-100" />

          <h3 className="text-[17px] font-black uppercase tracking-widest text-slate-900 mb-6">
            Contacto Directo
          </h3>
      ...
      <div className="mx-auto w-full max-w-[1400px]">
        <div className="w-full border-t border-white/20 pt-6 flex flex-col sm:flex-row justify-between items-center text-[13px] text-white/65 gap-4">
          ...
          <a href="#" className="flex items-center gap-1.5 transition-colors duration-300 hover:text-white group">
            Desarrollado por
            <span className="font-bold text-white/80 transition-colors duration-300 group-hover:text-primary">
              Kodamo estudio
            </span>
          </a>
        </div>
